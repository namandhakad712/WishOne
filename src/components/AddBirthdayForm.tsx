...
const AddBirthdayForm: React.FC<AddBirthdayFormProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="add-birthday-form sm:max-w-[500px] bg-white/95 rounded-xl border border-white/40 shadow-lg relative overflow-hidden max-h-[90vh] overflow-y-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
      >
