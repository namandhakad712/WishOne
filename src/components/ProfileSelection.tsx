...
const ProfileSelection = ({
  ...
  const profiles: Profile[] = [
    ...
    },
    {
      ...
      name: "Rose",
      image:
        "https://images.unsplash.com/photo-1548094990-c16ca90f1f0d?w=200&q=80",
      color: "bg-white",
    },
    {
      id: "11",
      name: "Ranunculus",
      image:
        "https://images.unsplash.com/photo-1589994159074-84471bf0c9ca?w=200&q=80",
      color: "bg-white",
    },
    {
      id: "12",
      name: "Dahlia",
      image:
        "https://images.unsplash.com/photo-1595171240733-a1a6469c7d9c?w=200&q=80",
      color: "bg-white",
    },
  ];
